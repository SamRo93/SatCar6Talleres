 ...
 * @author Samuel
 */
public class BusquedaProveedores extends javax.swing.JFrame {

    /**
     * Creates new form ProveedoresMostrar
     */
    
    ProveedormostrarController cmc = new ProveedormostrarController();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        List<Provedoresmostrar> list = new ArrayList<>();
        try {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ProveedoresEntity ce = cc.buscarPorId(id);
            if(ce != null){
                Proveedores cl = new Proveedores(ce);
                cl.setVisible(true);
            }
        } catch (Exception ex) {
            Logger.getLogger(BusquedaCliente.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BusquedaProveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BusquedaProveedores().setVisible(true);
            }
        });
    }
